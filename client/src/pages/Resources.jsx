...
function Resources() {
  return (
    <motion.div
      id="resources"
      className="flex flex-col mx-auto max-w-screen-2xl items-center p-10 bg-primary-light dark:bg-primary-dark overflow-y-auto h-full max-h-screen"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ delay: 0.3 }}
    >
      <h1 className="text-3xl font-bold text-h1-light dark:text-p-dark mb-10">
        Coding Resources
      </h1>
      <Tab />
    </motion.div>
        ...
        {buttonsList.map((tabButton, idx) => (
          <button
            ...
            className={`py-1 px-2 md:py-2  whitespace-nowrap md:px-4 text-sm md:text-lg border rounded-lg transition-colors duration-200 ease-in-out 
                        ${
                          tabState === idx + 1
                            ? "bg-orange-400 hover:bg-orange-400 dark:hover:bg-orange-400 text-[#212121] border-1 border-[#212121]"
                            : "dark:bg-[#2a2c2e] dark:hover:border-orange-400 hover:border-orange-600 dark:hover:text-orange-400 hover:text-orange-600 border-1 border-[#212121] text-[#212121] dark:text-p-dark "
                        }`}
          >
            {tabButton}
          </button>
