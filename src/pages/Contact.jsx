        ...
        <section className="" id="contact">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form ref={form} onSubmit={sendEmail} className="space-y-8 ">
                    ...
                    >
                        <input type="submit" value="Send" className="py-3 px-5 text-sm border border-teal-500 font-medium text-center text-p-light dark:text-p-dark rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 " />
                    </motion.div>
                </form>
