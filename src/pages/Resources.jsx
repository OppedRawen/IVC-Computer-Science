...
function Resources() {
    return (
        <motion.div id="resources" className="flex flex-col items-center p-10 bg-primary-light overflow-y-auto h-full max-h-screen" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
            <h1 className="text-3xl font-bold text-h1-light mb-10">Coding Resources</h1>
            <Tab />
        </motion.div>
    );
}
...
function Tab() {
    ...
    return (
        <div className="w-full mt-6 text-p-light">
