...
function Resources() {
    return (
        <motion.div id="resources" className="flex flex-col items-center p-10 bg-primary-light dark:bg-primary-dark overflow-y-auto h-full max-h-screen" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
